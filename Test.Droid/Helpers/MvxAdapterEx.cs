...
namespace Test.Droid.Helpers
{
			...
			, IMvxAdapter
	{
		...
		public MvxAdapterEx(Context context)
			: this(context, MvxAndroidBindingContextHelpers.Current())
		{
		}

		public MvxAdapterEx(Context context, IMvxAndroidBindingContext bindingContext)
		{
			_context = context;
		...
		protected MvxAdapterEx(IntPtr javaReference, JniHandleOwnership transfer)
